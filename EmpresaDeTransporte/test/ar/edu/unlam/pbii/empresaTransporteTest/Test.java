...
class Test {
	...
	void crearUnaBicicletaDeTransporteYQueValideSiLaCargaMaximaEsValida() {
		...
		Vehiculo bicicleta = new Bicicleta(15.0, 0.125);
		Paquete paquete1 = new Paquete(65.0, 0.075, "Castelar");
		Paquete paquete2 = new Paquete(4.0, 0.04, "Castelar");
		Paquete paquete3 = new Paquete(8.0, 0.05, "Castelar");
	...
	void crearUnaBicicletaDeTransporteYValidarQueElDestinoDeLasCargasSeaElMismo() {
		Integer valorEsperado = 2;
		Vehiculo bicicleta = new Bicicleta(15.0, 0.125);
		Paquete paquete1 = new Paquete(5.0, 0.075, "ramos mejía");
		Paquete paquete2 = new Paquete(6.0, 0.04, "Ramos Mejía");
		Paquete paquete3 = new Paquete(8.0, 0.05, "Castelar");
